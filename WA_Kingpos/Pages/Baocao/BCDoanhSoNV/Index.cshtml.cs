...
namespace WA_Kingpos.Pages.Baocao.BCDoanhSoNV
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnGet(string id, string id1, string id2, string id3, string id4, string id5, string id6, string id7, string id8)
        {
            ...
            {
                cls_Main.WriterLog(cls_Main.sFilePath, "DSDoanhSoNV Get", ex.ToString(), "0");
        ...
        private void LoadData(string id, string id1, string id2, string id3, string id4, string id5, string id6, string id7, string id8)
        {
            ...
            //string _tungay = clsMain.SQLString(String.Format("{0:yyyyMMdd HH:mm:ss}", dtpTungay.EditValue));
            //string _denngay = clsMain.SQLString(String.Format("{0:yyyyMMdd HH:mm:ss}", dtpDenngay.EditValue));
            sSQL = "";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                item.KICHCO = decimal.Parse(dr["KICHCO"].ToString()).ToString("N0");
                item.HESO_QUYDOI = decimal.Parse(dr["HESO_QUYDOI"].ToString()).ToString("N0");
                item.SANLUONG_TRUOC_QUYDOI_THUNG = decimal.Parse(dr["SANLUONG_TRUOC_QUYDOI_THUNG"].ToString()).ToString("N0");
                item.SANLUONG_TRUOC_QUYDOI_TAN = decimal.Parse(dr["SANLUONG_TRUOC_QUYDOI_TAN"].ToString()).ToString("N0");
                item.QUYDOI_PBL = decimal.Parse(dr["QUYDOI_PBL"].ToString()).ToString("N0");
                item.QUYDOI_BONGOC = decimal.Parse(dr["QUYDOI_BONGOC"].ToString()).ToString("N0");
                item.TONGSANLUONG_SAU_QUYDOI = decimal.Parse(dr["TONGSANLUONG_SAU_QUYDOI"].ToString()).ToString("N0");
                item.DONGIA = decimal.Parse(dr["DONGIA"].ToString()).ToString("N0");
                item.THANHTIEN_PBL = decimal.Parse(dr["THANHTIEN_PBL"].ToString()).ToString("N0");
                item.THANHTIEN_GOC = decimal.Parse(dr["THANHTIEN_GOC"].ToString()).ToString("N0");
                item.TONGTHANHTIEN = decimal.Parse(dr["TONGTHANHTIEN"].ToString()).ToString("N0");
