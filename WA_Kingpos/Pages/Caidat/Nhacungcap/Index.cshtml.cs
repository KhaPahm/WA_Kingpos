...
namespace WA_Kingpos.Pages.Nhacungcap
{
    ...
    {
        public List<clsNhacungcap> listitem = new List<clsNhacungcap>();
        ...
        public IActionResult OnGet()
        {
            try
            {
                ...
                {
                    bThem = cls_UserManagement.AllowAdd("9", HttpContext.Session.GetString("Permission"));
                ...
                {
                    clsNhacungcap item = new clsNhacungcap();
            ...
            {
                cls_Main.WriterLog(cls_Main.sFilePath, "NHACUNGCAP", ex.ToString(), "0");
