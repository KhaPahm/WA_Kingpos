    ...
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            try
            {
                ...
                string sSQL = "EXEC SP_FINA_SELECT_DATA @LOAI=58, @USERLOGIN =" + cls_Main.SQLString(manhanvien);
            ...
            {
                cls_Main.WriterLog(cls_Main.sFilePath, "DuyetCongNoFina", ex.ToString(), "0");
