...
namespace WA_Kingpos.Pages.Thuyentruong
{
    ...
    public class DeleteModel : PageModel
    {
        public IActionResult OnGet(string id)
        {
            ...
            {
                //check quyen
                if (!cls_UserManagement.AllowDelete("2023112201", HttpContext.Session.GetString("Permission")))
                {
            ...
            {
                cls_Main.WriterLog(cls_Main.sFilePath, "Thuyentruong Delete", ex.ToString(), "0");
