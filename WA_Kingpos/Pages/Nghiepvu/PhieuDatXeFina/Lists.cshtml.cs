    ...
    public class ListsModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            try
            {
                ...
                string sSQL = "EXEC SP_FINA_SELECT_DATA @LOAI=53, @USERLOGIN =" + cls_Main.SQLString(manhanvien);
            ...
            {
                cls_Main.WriterLog(cls_Main.sFilePath, "PhieuDatXeFina List", ex.ToString(), "0");
