...
namespace WA_Kingpos.Pages.Nghiepvu.PhieuDatHangFina
{
    ...
    public class ListsModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            ...
            {
                //check quyen
                if (!cls_UserManagement.AllowView("14102301", HttpContext.Session.GetString("Permission")))
                {
                ...
                string sSQL = "EXEC SP_FINA_SELECT_DATA @LOAI=48, @USERLOGIN =" + cls_Main.SQLString(manhanvien);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    item.trangthai1 = dr["TRANGTHAI1"].ToString();
            ...
            {
                cls_Main.WriterLog(cls_Main.sFilePath, "PhieuDatHangFina List", ex.ToString(), "0");
